...
export default function InteractiveButton({
  ...
  return (
    <button
      className={cn(
        "text-text-secondary-dark-blue hover:bg-tertiary-blue focus:bg-tertiary-blue group flex h-[3.313rem] w-[2.5rem] flex-col items-center justify-center gap-y-[0.313rem] rounded-[0.625rem] bg-secondary-white pt-[0.25rem] text-[0.813rem] font-bold tracking-[-0.011rem] outline-none transition-colors duration-100 ease-in-out",
        {
